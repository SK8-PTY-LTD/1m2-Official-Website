...
$(document).ready(function() {
  ...
  var DragControlController = (function() {
    ...
    DragControlController.prototype.handleDrag = function() {
      ...
      TweenLite.set(this.$knobArrow, {
        opacity: (1 - Math.max(0, dragProgress - 0.8) * 5)
      });
      this.dispatch(DragControlController.EVENT_UPDATE_DRAG, {
    ...
    DragControlController.prototype.completeKnob = function() {
      ...
      TweenLite.to(counter, duration, {
        ...
        onUpdate: function() {
          _this.dispatch(DragControlController.EVENT_UPDATE_DRAG, {
            progress: counter.x / _this.getDragMax()
          });
        },
        onComplete: function() {
